...
This file mainly implement the math necessary to move the robot.  
...
\begin{DoxyCompactList}\small\item\em callback of odometry subscriber. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em function that normalize the angle \end{DoxyCompactList}\item 
def \mbox{\hyperlink{go__to__point_8py_a9c3011a3065fcbefcc1c5ad8c9979669}{go\+\_\+to\+\_\+point.\+fix\+\_\+yaw}} (des\+\_\+pos)
\begin{DoxyCompactList}\small\item\em This function adjusts the angle by taking in input the goal of the robot. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{go__to__point_8py_ac8579665c0fbf665f734476554fac37d}{go\+\_\+to\+\_\+point.\+go\+\_\+straight\+\_\+ahead}} (des\+\_\+pos)
\begin{DoxyCompactList}\small\item\em This function adjust the velocities to reach the goal. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em function that perfoms final yaw adjustments. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em function to stop the robot by setting the linear and angular velocity to 0. \end{DoxyCompactList}\item 
def \mbox{\hyperlink{go__to__point_8py_ad80fa73a15e1a5576fea98b4958dcef4}{go\+\_\+to\+\_\+point.\+planning}} (goal)
\begin{DoxyCompactList}\small\item\em callback function of the action server \end{DoxyCompactList}\item 
...
\item 
\mbox{\Hypertarget{go__to__point_8py_a803f37d88a98fcb432b07c5f1366d924}\label{go__to__point_8py_a803f37d88a98fcb432b07c5f1366d924}} 
{\bfseries go\+\_\+to\+\_\+point.\+desired\+\_\+position} = Point()
\item 
...
callback of odometry subscriber. 
...
\hline
\end{DoxyParams}
Description \+: It reads the msg containing the information about the robot position and yaw. At the end, it computes the euler angle for the yaw from the given quaternion \mbox{\Hypertarget{go__to__point_8py_a9c3011a3065fcbefcc1c5ad8c9979669}\label{go__to__point_8py_a9c3011a3065fcbefcc1c5ad8c9979669}} 
...
This function adjusts the angle by taking in input the goal of the robot. 

Description \+: Once the robot is rotated of the right angle (taking in cosideration the angle of the goal), it moves toward that direction with a certain velocity published by the twist message. \mbox{\Hypertarget{go__to__point_8py_ac8579665c0fbf665f734476554fac37d}\label{go__to__point_8py_ac8579665c0fbf665f734476554fac37d}} 
...
This function adjust the velocities to reach the goal. 

Description If the error from computing the distance position, between the goal and the actual postion, is greater than a certain threshold then the robot can slow down and adjust its orientantion and move again directly to the goal \mbox{\Hypertarget{go__to__point_8py_ab92bd6db1ec323a4d795ed6cb40aebe1}\label{go__to__point_8py_ab92bd6db1ec323a4d795ed6cb40aebe1}} 
...
Here the node is defined as \char`\"{}go\+\_\+to\+\_\+point\char`\"{} \mbox{\Hypertarget{go__to__point_8py_ac688bb56fa84763ea2edefc30cae032a}\label{go__to__point_8py_ac688bb56fa84763ea2edefc30cae032a}} 
...
function that normalize the angle 
...
callback function of the action server 


\begin{DoxyParams}{Parameters}
{\em desired\+\_\+position\+\_\+x} & \\
\hline
{\em desired\+\_\+position\+\_\+y} & \\
\hline
{\em desired\+\_\+yaw} & \\
\hline
\end{DoxyParams}
Description\+: It takes the goal coordinates and once the robot has reached it (or not) it provides the result and the feedback. In function of the robot\textquotesingle{}s position respect to the goal, it can provides feedback about the state, and change it accordingly. Moreover, if the goal is preempted it stops the robot. ~\newline
